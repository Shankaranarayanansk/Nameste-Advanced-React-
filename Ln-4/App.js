...
const RestaurantCard = (
  props // getting the card by props
) => {
  const { resdata } = props;
  const {
    cuisines,
    ...
    deliveryTime,
    avgRating,
  } = resdata?.data; //destructuring and optional chaninging
  return (
    <div className="res-card" style={style}>
      ...
      <h4>Cost for Two in : ₹{costForTwo / 100}</h4>
      <h4>Delivery Time within :{deliveryTime} mins</h4>
    </div>
  );
};
